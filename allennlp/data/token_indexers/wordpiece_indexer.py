...
class WordpieceIndexer(TokenIndexer[int]):
    ...
    def tokens_to_indices(self,
        ...
        if len(flat_wordpiece_ids) <= window_length:
            ...
            # print("self._start_piece_ids", len(self._start_piece_ids))
            # print("self._end_piece_ids", len(self._end_piece_ids))
            # print("len(flat_wordpiece_ids)", len(flat_wordpiece_ids))
            # print("flat_wordpiece_ids", flat_wordpiece_ids)
